...
8. Open the Gidk Engine source folder, click on the address bar and type `cmd` to open a command prompt window.
...
4. Open a terminal in the Gidk Engine source folder, and run `update.sh`.
